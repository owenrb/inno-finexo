...
If you want or need to start _without_ bootstrapping the development data, for example when testing
against an existing repository, you can specify the _additional_ Maven profile without-development-data to do so:
...
After your project is set up, access the CMS at <http://localhost:8080/cms> and the site at <http://localhost:8080/innofinexo>.
...
as io.owenrbee.hippo/inno-finexo:0.1.0-SNAPSHOT
